...
namespace TreatsApp.Migrations
{
    public partial class InitialMigrate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Treat_FlavorId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TreatId = table.Column<int>(type: "int", nullable: false),
                    FlavorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Treat_Flavors", x => x.Treat_FlavorId);
                    table.ForeignKey(
                        name: "FK_Treat_Flavors_Flavors_FlavorId",
                        column: x => x.FlavorId,
                        principalTable: "Flavors",
                        principalColumn: "FlavorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Treat_Flavors_Treats_TreatId",
                        column: x => x.TreatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Treat_Flavors_FlavorId",
                table: "Treat_Flavors",
                column: "FlavorId");

            migrationBuilder.CreateIndex(
                name: "IX_Treat_Flavors_TreatId",
                table: "Treat_Flavors",
                column: "TreatId");
